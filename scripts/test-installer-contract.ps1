...
Assert-Match $builder 'performance-tracker-installer-build-v3' 'Builder must emit the signed installer provenance format'
...
Assert-Match $builder 'recordSignaturePath' 'Production provenance must name its detached signature'
