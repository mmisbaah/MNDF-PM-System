...
try {
  ...
  foreach($name in @('test-release-database-ownership.ps1','test-release-lint-gate.ps1','test-deployment-task-guards.ps1','test-deployment-journal.ps1','test-production-acls.ps1','test-protected-secret-file.ps1','test-serialize-production-env.ps1','test-release-source-check.ps1','test-installer-contract.ps1','test-installer-approval.ps1','test-installer-package-acl.ps1','test-installer-package-verification.ps1','test-installer-launcher-integrity.ps1','test-node-runtime-resolution.ps1')){
