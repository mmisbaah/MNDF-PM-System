...
try{
  ...
  $record=[ordered]@{format='performance-tracker-installer-build-v3';recordPath=$recordPath;recordSignaturePath=$null;path=$installer;sha256=$hash;releaseCommit=('a'*40);releaseId='test';version='0.1.0-test';compilerSha256=('b'*64);compilerSigner='test';nodeRuntimeVersion='v24.0.0';nodeRuntimeSha256=('c'*64);releasePublicKeySha256=('d'*64);productionHelperAllowlistSha256=('e'*64);authenticodeStatus='NotSigned';productionAuthorized=$false;createdAt='2026-01-01T00:00:00.0000000Z'}
